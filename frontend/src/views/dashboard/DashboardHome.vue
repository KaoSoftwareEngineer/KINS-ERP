...
export default {
  ...
  methods: {
    loadCardPrefs() {
      const def = { tasks: true, stats: true, charts: true, mini: true, activities: true, orders: true };
    ...
    resetCards() { this.cards = { tasks: true, stats: true, charts: true, mini: true, activities: true, orders: true }; this.saveCardPrefs(); this.customizeOpen = false; },
