<template>
<div class="po-page">
  <div class="po-titlebar">🎨 รับผ้าย้อม</div>
  ...
  <div class="po-head">
    ...
    <div class="po-head-col">
      <div class="po-field"><label>เลขที่ออร์เดอร์</label>
        <select v-model="form.order_ref" @change="selectOrder">
          <option value="">— เลือกใบสั่งย้อม —</option>
  ...
  methods: {
    ...
    async openReceiptPdf() {
      ...
      const html = `
        ...
        <div class="center h2">ใบรับผ้าย้อม (Dyed Fabric Receipt)</div>
