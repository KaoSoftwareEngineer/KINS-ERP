...
.po-field input, .po-field select, .po-field textarea { padding: 6px 9px; border: 1px solid var(--field-border); border-radius: 6px; font-size: 13px; font-family: inherit; background: var(--surface); color: var(--text); min-width: 150px; }
.po-field textarea { width: 100%; resize: vertical; }
