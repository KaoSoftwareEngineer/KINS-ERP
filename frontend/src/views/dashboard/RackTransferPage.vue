...
.rt-field input { height: 40px; padding: 0 12px; border: 1px solid var(--field-border); border-radius: 9px; font-size: 12px; font-family: inherit; background: var(--field); color: var(--text); transition: border-color .2s, box-shadow .2s; }
...
.po-items { padding: 8px 12px; min-height: 140px; }
...
.po-foot-row td { padding: 10px 8px; border-top: 2px solid var(--field-border); font-weight: 700; font-size: 12px; }
...
.po-btn { display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; border: 1px solid var(--field-border); border-radius: 8px; font-weight: 600; cursor: pointer; font-family: inherit; font-size: 12px; background: #e7eaf1; color: var(--text); transition: background .2s, border-color .2s; }
